...
This document provides a summary of the frontend application for the `nagent` project.

## Project Structure

The frontend is a standard React application built with Vite. The main source code is located in the `nagent/src` directory.
